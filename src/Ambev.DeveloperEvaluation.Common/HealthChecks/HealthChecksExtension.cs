...
public static class HealthChecksExtension
{
    ...
    /// Additionally, this method adds health checks for:
    /// <list type="bullet">
    /// <item>
    /// <description>PostgreSQL database connection (tagged with "readiness" and "database")</description>
    /// </item>
    /// <item>
    /// <description>MongoDB connection (tagged with "readiness" and "database")</description>
    /// </item>
    /// <item>
    /// <description>Redis cache connection (tagged with "readiness" and "cache")</description>
    /// </item>
    /// </list>
    /// </remarks>
    /// <example>
    ...
    public static void AddBasicHealthChecks(this WebApplicationBuilder builder)
    {
        ...
        if (!string.IsNullOrEmpty(postgresConnection))
        {
            healthChecksBuilder.AddNpgSql(
                ...
                tags: ["readiness", "database", "postgresql"]
            );
        }
        ...
        if (!string.IsNullOrEmpty(mongoConnection))
        {
            healthChecksBuilder.AddMongoDb(
                ...
                name: "MongoDB",
                failureStatus: HealthStatus.Unhealthy,
                tags: ["readiness", "database", "mongodb"]
            );
        }
